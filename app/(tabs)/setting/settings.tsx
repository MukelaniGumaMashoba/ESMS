                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1, gap: 10, marginBottom: 10 }}>
                    ...
                    <View>
                        ...
                        <View style={styles.appearance}>
                            ...
                            <TouchableOpacity onPressIn={() => router.navigate('/(tabs)/setting/privacy')}>
                                <Ionicons name='arrow-forward-circle-outline' size={24} color={"grey"} />
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={styles.appearance}>
                            ...
                            <TouchableOpacity onPressIn={() => router.navigate('/(tabs)/setting/about')}>
                                <Ionicons name='arrow-forward-circle-outline' size={24} color={"grey"} />
                            </TouchableOpacity>
                        </View>
                        ...
                        {/* Quiz Reminder */}
                        <View style={styles.appearance}>
                            <Ionicons name='bulb-sharp' size={30} color={"lightblue"} />
                            <View>
                                <Text>Play Quiz</Text>
                                <Text>Have fun and enjoy</Text>
                            </View>
                            <TouchableOpacity onPressIn={() => router.navigate('/(tabs)/setting/quiz')}>
                                <Ionicons name='arrow-forward-circle-outline' size={24} color={"grey"} />
                            </TouchableOpacity>
                        </View>
                    </View>
